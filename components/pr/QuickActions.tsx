        ...
        <div className="bg-white rounded-2xl border border-black/5 shadow-sm overflow-hidden">
            ...
            <div className="p-2">
                {ACTIONS.map((action, idx) => (
                    ...
                    >
                        <div className="w-9 h-9 rounded-lg bg-black/[0.03] flex items-center justify-center text-black/50 group-hover:text-black group-hover:bg-black/[0.06] transition-colors">
                            {action.icon}
                        </div>
