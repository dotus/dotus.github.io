...
export const JournalistSection: React.FC = () => {
    return (
        <section
            id="journalists"
            className="py-32 text-white relative border-b border-black overflow-hidden"
            style={{
        ...
        >
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                    ...
                    >
                        <h2 className="text-6xl md:text-6xl font-bold  mb-2">
                            WE WROTE <br />
                            THE HEADLINES.
                        </h2>
                        ...
                        <div className="text-black py-2 max-w-lg">
                            <p className="text-xl md:text-2xl leading-relaxed font-light">
                                We aren't guessing what newsrooms want. We know. Because for years, <span className="font-bold border-b-2 border-black">we were the ones deleting bad pitches</span> and publishing the good ones.
                            </p>
                        </div>
                    </motion.div>
