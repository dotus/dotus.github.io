        ...
        <div className="relative min-h-screen bg-[#0a0a0a] text-white overflow-x-hidden">
            ...
            <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 border-b ${isScrolled ? 'bg-black/60 backdrop-blur-xl border-white/10' : 'bg-transparent border-transparent'}`}>
                <div className="max-w-7xl mx-auto px-6 md:px-12">
                    <div className="flex justify-between items-center h-20">
                        <CayblesLogo size="full" theme="white" height={48} />
            ...
            <div className="relative z-10">
                ...
                >
                    ...
                    {/* Card 1: Kanban - Front right, full opacity */}
                    <motion.div 
                        initial={{ opacity: 0, x: 100 }}
                        animate={{ opacity: 1, x: 0 }}
                        transition={{ duration: 1, delay: 0.4 }}
                        className="absolute top-1/4 right-4 md:right-16 lg:right-32 w-64 hidden lg:block z-30"
                        style={{ transform: 'perspective(1000px) rotateY(-12deg) rotateX(3deg)' }}
                    >
                        <FloatingKanbanCard />
                    </motion.div>

                    {/* Card 2: Timeline - Front left, full opacity */}
                    <motion.div 
                        initial={{ opacity: 0, x: -100 }}
                        animate={{ opacity: 1, x: 0 }}
                        transition={{ duration: 1, delay: 0.6 }}
                        className="absolute bottom-1/3 left-4 md:left-16 lg:left-32 w-56 hidden lg:block z-30"
                        style={{ transform: 'perspective(1000px) rotateY(12deg) rotateX(-3deg)' }}
                    >
                        <FloatingTimelineCard />
                    </motion.div>

                    {/* Card 3: Deadline Alert - Mid left, 70% opacity */}
                    <motion.div 
                        initial={{ opacity: 0, y: 50 }}
                        animate={{ opacity: 0.7, y: 0 }}
                        transition={{ duration: 1, delay: 0.8 }}
                        className="absolute top-20 left-1/4 w-48 hidden lg:block z-20"
                        style={{ transform: 'perspective(1000px) rotateY(8deg) rotateX(5deg) scale(0.9)' }}
                    >
                        <FloatingDeadlineCard />
                    </motion.div>

                    {/* Card 4: Product Preview - Mid right, 50% opacity */}
                    <motion.div 
                        initial={{ opacity: 0, y: 50 }}
                        animate={{ opacity: 0.5, y: 0 }}
                        transition={{ duration: 1, delay: 1 }}
                        className="absolute bottom-20 right-1/4 w-52 hidden lg:block z-20"
                        style={{ transform: 'perspective(1000px) rotateY(-8deg) rotateX(-5deg) scale(0.85)' }}
                    >
                        <FloatingProductCard />
                    </motion.div>
                    ...
                    <div className="flex-1 flex items-center justify-center px-6 pt-32 pb-16 relative z-10">
                        <div className="max-w-4xl mx-auto text-center">
                            ...
                            >
                                 The PR toolkit for growing businessess
                            </motion.p>
                ...
                <div id="tour" className="relative">
                    <section className="py-32 px-6 bg-gradient-to-br from-[#FAF9F6] via-white to-teal-50/30 text-gray-900 relative overflow-hidden">
                        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-20 items-center relative">
                            <div className="space-y-6">
                                <h2 className="text-5xl md:text-6xl text-gray-900 font-serif">
                                    Yes, one size fits all 
                                </h2>
                                <p className="text-lg md:text-xl text-gray-500 font-light">
                                  Big announcement or small update: plan, track, review, and publish it all in one hub.
                                </p>
                            </div>
                            <div>
                                <QuestsDemo />
                    ...
                    <section className="py-32 px-6 bg-gradient-to-br from-[#0a0a0a] via-[#111] to-[#0a0a0a] text-white relative overflow-hidden">
                        <div className="absolute inset-0" style={{ backgroundImage: 'radial-gradient(circle at 80% 20%, rgba(45,212,191,0.15) 0%, transparent 60%)' }}></div>
                        ...
                        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-20 items-center relative">
                            ...
                            <div className="space-y-6 order-1 md:order-2">
                                <h2 className="text-5xl md:text-6xl text-white font-serif">
                                   Everything for your campaign, in one place
                                </h2>
                                <p className="text-lg md:text-xl text-white/50 font-light">
                                    Centralize docs and emails, draft new assets, track announcements and deadlines, and schedule social posts for launches big or small.
                                </p>
                            </div>
                        </div>
                    </section>

                    <section className="py-32 px-6 bg-gradient-to-br from-[#FAF9F6] via-white to-gray-50/50 text-gray-900 relative overflow-hidden">
                        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-20 items-center relative">
                            <div className="space-y-6">
                                <h2 className="text-5xl md:text-6xl text-gray-900 font-serif">
                                    Craft your story
                    ...
                    <section className="py-32 px-6 bg-gradient-to-br from-[#0a0a0a] via-[#0f0f0f] to-[#0a0a0a] text-white relative overflow-hidden">
                        <div className="absolute inset-0" style={{ backgroundImage: 'radial-gradient(circle at 50% 50%, rgba(139,92,246,0.15) 0%, transparent 60%)' }}></div>
                        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-20 items-center relative">
                            <div className="order-2 md:order-1">
                                <DistributionsDemo />
                            </div>
                    ...
                    <section className="py-32 px-6  text-white relative overflow-hidden">
                        <div className="absolute inset-0" style={{ backgroundImage: 'radial-gradient(circle at 70% 70%, rgba(251,191,36,0.12) 0%, transparent 60%)' }}></div>
                        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-20 items-center relative">
                            <div className="space-y-6">
                                <h2 className="text-5xl md:text-6xl text-white font-serif">
                ...
                <section className="py-40 px-6 text-white relative overflow-hidden">
                    ...
                    <div className="max-w-4xl mx-auto text-center space-y-10 relative">
                        <h2 className="text-6xl md:text-8xl text-white font-serif">
                            Ready to tell
                            <br />
...
const FloatingKanbanCard: React.FC = () => (
    <div className="bg-gradient-to-br from-teal-50/90 to-white/90 rounded-xl shadow-2xl overflow-hidden border border-teal-100/50 backdrop-blur-sm">
...
const FloatingTimelineCard: React.FC = () => (
    <div className="bg-gradient-to-br from-violet-50/80 to-white/80 rounded-xl shadow-xl overflow-hidden border border-violet-200/50 backdrop-blur-sm">
...
// Card 3: Deadline Alert - Lower opacity, mid-ground
const FloatingDeadlineCard: React.FC = () => (
    <div className="bg-amber-50 rounded-xl shadow-xl overflow-hidden border border-amber-200/50 backdrop-blur-sm">
...
// Card 4: Product Preview - Lowest opacity, background
const FloatingProductCard: React.FC = () => (
    <div className="bg-gradient-to-br from-blue-50/70 to-white/70 rounded-xl shadow-xl overflow-hidden border border-blue-200/40 backdrop-blur-sm">
