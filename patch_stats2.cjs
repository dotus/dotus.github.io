...
const oldJournalists = `export const MOCK_JOURNALISTS: JournalistContact[] = [
...
const newJournalists = `export const MOCK_JOURNALISTS: JournalistContact[] = [
...
content = content.replace(oldJournalists, newJournalists);
fs.writeFileSync(file, content);
console.log('Fixed StatsOverview.tsx');
