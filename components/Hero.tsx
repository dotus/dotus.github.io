...
export const Hero: React.FC<HeroProps> = ({ onOpenModal }) => {
    ...
    const progressWidth = useMemo(() => `${(step / (STEPS.length - 1)) * 100}%`, [step]);
    const mobileProgressWidth = useMemo(() => `${((step + 1) / STEPS.length) * 100}%`, [step]);

    // Animation sequence logic - slower on mobile
    useEffect(() => {
        if (intervalRef.current) clearTimeout(intervalRef.current);

        const nextStep = (step + 1) % STEPS.length;
        const delay = isMobileRef.current ? 2000 : 1500;
    ...
    // Auto-scroll to bottom of chat - use requestAnimationFrame for smoother updates
    useEffect(() => {
    ...
    const handleManualStep = useCallback((index: number) => {
        setStep(index);
    }, []);
    ...
    return (
        <section className="relative min-h-screen flex flex-col overflow-hidden border-b border-black pt-28 lg:pt-32 pb-0 bg-transparent">
            ...
            {/* Dither Pattern - Z-10 */}
            <DitherPattern opacity={0.2} className="z-10" />

            {/* Gradient decoration - simplified, no blur */}
            <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-gradient-to-b from-gray-800/30 to-black/30 rounded-full opacity-30 -translate-y-1/2 translate-x-1/3 pointer-events-none z-0" />

            {/* Floating Elements - Z-20 - simplified, no mix-blend or blur */}
            <div className="absolute top-0 left-0 w-full h-full z-20 opacity-10 pointer-events-none overflow-hidden">
                <div className="w-full h-2 bg-white/10 absolute top-1/4"></div>
                <div className="w-full h-20 bg-cyan-500/10 absolute bottom-1/3"></div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 w-full z-30 flex-1 flex flex-col">
                ...
                <div className="hidden lg:block w-full max-w-4xl mx-auto relative z-50 mb-16 pt-2">
                    <div className="relative flex items-center justify-between px-2">
                        ...
                        <div
                            className="absolute top-1/2 left-0 h-[3px] -translate-y-1/2 bg-white -z-10 origin-left rounded-full will-change-[width]"
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center flex-1">
                    ...
                    <div className="lg:hidden w-full mb-4 mt-2">
                        <div className="flex flex-col items-start gap-2 border-l-2 border-white/20 pl-4">
                            ...
                            <div
                                key={step}
                                className="text-2xl font-bold text-white uppercase tracking-tighter transition-opacity duration-300"
                            >
                                {STEPS[step].label}
                            </div>
                            {/* Progress Line */}
                            <div className="w-full h-[2px] bg-white/10 mt-1 relative overflow-hidden max-w-[200px]">
                                <div
                                    ...
                                    style={{ width: mobileProgressWidth, transition: 'width 500ms ease-out' }}
                                />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="relative w-full flex items-center justify-center lg:justify-end min-h-[450px] lg:min-h-[500px]">
                        {/* Simplified card - no PerspectiveCard on mobile for performance */}
                        <div className="w-full lg:hover:scale-[1.01] lg:transition-transform lg:duration-300">
                            {/* Main Container - removed backdrop-blur for performance */}
                            <div className="w-full bg-black/60 border border-white/20 shadow-2xl rounded-lg overflow-hidden flex flex-col h-[450px] md:h-[550px] font-sans text-sm relative mx-auto">

                                {/* Slack Sidebar */}
                                <div className="flex h-full">
                                    {/* Icon Rail */}
                                    <div className="w-12 md:w-14 bg-white/5 border-r border-white/10 flex flex-col items-center py-4 gap-4 flex-shrink-0">
                                    ...
                                    {/* Channel Rail */}
                                    <div className="w-40 bg-black/40 border-r border-white/10 text-gray-300 flex flex-col py-3 hidden sm:flex flex-shrink-0">
                                    ...
                                    <div className="flex-1 flex flex-col bg-transparent relative min-w-0">
                                        {/* Header */}
                                        <div className="h-10 border-b border-white/10 flex items-center justify-between px-4 bg-white/5 flex-shrink-0">
                                        ...
                                        {/* Messages Container - contain: layout for performance */}
                                        <div ref={scrollRef} className="flex-1 p-4 overflow-y-auto space-y-4 contain-layout">

                                            {/* Step 0: Bot Suggestion - Always visible */}
                                            ...
                                            <div className={`flex gap-3 transition-all duration-300 ${step >= 1 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2 pointer-events-none h-0 overflow-hidden'}`}>
                                                <div className="w-8 h-8 bg-blue-600 rounded-sm flex items-center justify-center text-white font-bold text-[10px] flex-shrink-0">JD</div>
                                                <div>
                                            ...
                                            {/* Step 2: Bot Draft */}
                                            <div className={`flex gap-3 group transition-all duration-300 ${step >= 2 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2 pointer-events-none h-0 overflow-hidden'}`}>
                                                <div className="w-8 h-8 bg-white rounded-sm flex items-center justify-center text-black flex-shrink-0 shadow-sm">
                                                    <Bot className="w-4 h-4" />
                                                </div>
                                                <div className="w-full min-w-0">
                                                    ...
                                                    <div className="border border-white/20 rounded-md max-w-sm overflow-hidden bg-white/5">
                                            ...
                                            <div className={`flex gap-3 transition-all duration-300 ${step >= 3 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2 pointer-events-none h-0 overflow-hidden'}`}>
                                                <div className="w-8 h-8 bg-blue-600 rounded-sm flex items-center justify-center text-white font-bold text-[10px] flex-shrink-0">JD</div>
                                                <div>
                                                    <div className="flex items-baseline gap-2">
                                                        <span className="font-bold text-xs sm:text-sm text-white">John Doe</span>
                                            ...
                                            <div className={`flex gap-3 pl-3 relative transition-all duration-300 ${step >= 4 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2 pointer-events-none h-0 overflow-hidden'}`}>
                                                ...
                                                <div className="w-8 h-8 bg-gray-200 rounded-sm overflow-hidden flex-shrink-0 shadow-sm ring-1 ring-white">
                                                    <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?q=80&w=100&auto=format&fit=crop" alt="Sarah" className="w-full h-full object-cover" loading="lazy" />
                                                </div>
                                                <div className="w-full min-w-0">
                                                    <div className="flex items-baseline gap-2">
                                                    ...
                                                    <div className="border border-green-500/30 rounded-md max-w-xs overflow-hidden bg-green-500/10">
                                                        <div className="bg-green-500/20 px-2 py-1.5 flex items-center justify-between border-b border-green-500/20">
                                                            ...
                                                            <span className="text-[8px] uppercase font-bold text-black bg-green-400 px-1 rounded">Polished</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className={`flex gap-3 transition-all duration-300 ${step >= 5 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2 pointer-events-none h-0 overflow-hidden'}`}>
                                                <div className="w-8 h-8 bg-blue-600 rounded-sm flex items-center justify-center text-white font-bold text-[10px] flex-shrink-0">JD</div>
                                                <div>
                                                    <div className="flex items-baseline gap-2">
                                                        <span className="font-bold text-xs sm:text-sm text-white">John Doe</span>
                                            ...
                                            <div className={`flex gap-3 transition-all duration-300 ${step >= 6 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2 pointer-events-none h-0 overflow-hidden'}`}>
                                                <div className="w-8 h-8 bg-white rounded-sm flex items-center justify-center text-black flex-shrink-0 shadow-sm">
                                                    <Bot className="w-4 h-4" />
                                                </div>
                                                <div>
                                        ...
                                        {/* Input Area */}
                                        <div className="p-3 sm:p-4 border-t border-white/10 bg-white/5 mt-auto">
